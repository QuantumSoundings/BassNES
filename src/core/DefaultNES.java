...
/**
 * Object representing an DefaultNES console. This and NesSettings are the only two files that should be interacted with.
 * Object is a runnable, so it can occupy its own thread or be controlled through a main program.
 * @author Jordan Howe
 *
 */
public class DefaultNES implements Runnable, NES {
	...
	public final void run(){
		System.out.println("DefaultNES STARTED RUNNING");
		while(flag){
			autoRunFrame();
			if(pause){
				pauseConfirmed = true;
