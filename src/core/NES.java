...
/**
 * Interface of guaranteed functions provided by a DefaultNES object.
 * @author Jordan Howe
 *
 */
public interface NES extends Runnable {
	 ...
	 */
	/**
	 * DefaultNES is a runnable and can be treated as such.
	 * These are the relevant methods.
	 */
	void run();
	/**
	 * Causes the thread running the DefaultNES instance to terminate.
	 */
	void exit();
	/**
	 * Pauses a running DefaultNES instance. Returns when the nes has
	 * successfully paused.
	 */
	void pause();
	/**
	 * Unpauses a paused DefaultNES instance. Returns immediately.
	 */
	void unpause();
	/**
	...
	/*
	 * Debug and DefaultNES state functions.
	 */
