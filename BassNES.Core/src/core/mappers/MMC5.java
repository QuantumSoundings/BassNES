...
public class MMC5 extends Mapper {
	...
	void cartridgeWrite(int index,byte b){
		if(index>=0x5000&&index<=0x5007){
			...
			//System.out.println("Writing PCM index: "+Integer.toHexString(index) +" data: "+Integer.toBinaryString((0xff&b)));
			channel.registerWrite(index, b);
		}
	...
	private void configuration(int index,byte b){
		...
		case 0x5104:
			if(EXT_ram_mode!=(b&3))
				System.out.println("EXTRAM MODE: "+Integer.toBinaryString((0xff&b)));
			EXT_ram_mode = b&3;break;
		case 0x5105:
			//System.out.println("NameTable Assignments: "+Integer.toBinaryString((0xff&b)));
			int pos = (0xff&b);
			for(int i = 0; i<4;i++){
				//pos= pos>>(i*2);
				switch(pos&3){
	...
	private void prgBankSwitching(int index,byte b){
		if(index==0x5113){//PRG_Ram banking
			//System.out.println("5113: "+Integer.toHexString((0xff&b)));
			PRG_RAM = PRG_RAM_banks[b&7];
		}
		else if(index==0x5114){
			//System.out.println("5114: "+Integer.toHexString((0xff&b)));
			if(PRG_mode==3){
				if(b>0){
			...
			//System.out.println("5115: "+Integer.toHexString((0xff&b)));
			switch(PRG_mode){
			case 1: case 2:
				if(b>0){
			...
			switch(PRG_mode){
			case 2: case 3:
				//System.out.println("5116: "+Integer.toHexString((0xff&b)));
				if(b>0){
			...
			//System.out.println("5117: "+Integer.toHexString((0xff&b)));
			//cpu.debug(0);
	...
	private void chrBankSwitching(int index,byte b){//TODO - Mostly done.
		int val = upperchr|(0xff&b);
		//System.out.println(Integer.toHexString(index)+": "+Integer.toHexString((0xff&b)));
		switch(index){
		case 0x5120:
	...
	private void otherRegisters(int index,byte b){
		switch(index){
		case 0x5200:System.out.println("Vertical Split Write: "+Integer.toBinaryString((0xff&b)));break;
		case 0x5201:System.out.println("VerticalS Scroll Write");break;
		case 0x5202:System.out.println("VSplit Bank Write");break;
		case 0x5203:irqscanline = (0xff&b);break;
